...
public class PlaceRevsService {
    ...
    static {
        reviews.add(new Review("user0", 0, "review0", 1));
        reviews.add(new Review("user1", 1, "review1", 2));
        reviews.add(new Review("user2", 2, "review2", 3));
        reviews.add(new Review("user3", 3, "review3", 3));
    }

...
public class UserPageController {
    ...
    @RequestMapping(value="/user/visibility", method=RequestMethod.POST, produces=MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<HttpStatus> changeVisibility(Model model, @RequestBody User currentUser) {
        userRepository.changeVisibility(currentUser);
        return new ResponseEntity<HttpStatus>(HttpStatus.OK);
    }


    @RequestMapping(value="/user/username", method=RequestMethod.POST, produces=MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<HttpStatus> changeUsername(Model model, @RequestBody User currentUser) {
        userRepository.changeUsername(currentUser);
        return new ResponseEntity<HttpStatus>(HttpStatus.OK);
    }


    @RequestMapping(value="/user/password", method=RequestMethod.POST, produces=MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<HttpStatus> changePassword(Model model, @RequestBody User currentUser) {
        userRepository.changePassword(currentUser);
        return new ResponseEntity<HttpStatus>(HttpStatus.OK);
    }
